...
/***/ function(module, exports, __webpack_require__) {
	...
	var _cycleAnimationDriver = __webpack_require__(63);

	var _fp = __webpack_require__(66);

	var COLORS = ['#2f3439', '#95BF78', '#DA7E00', '#D92626'];

	var linearGradient = function linearGradient(pourcent) {
	  var level = (0, _fp.floor)(pourcent);
	  var COLOR = COLORS[level + 1] || (0, _fp.head)(COLORS);
	  var BACKGROUND_COLOR = COLORS[level];

	  var remainder = pourcent % 1;
	  if (remainder > 0.50) return 'linear-gradient(' + (90 + remainder * 360) + 'deg, ' + COLOR + ' 50%, rgba(0, 0, 0, 0) 50%, rgba(0, 0, 0, 0)), linear-gradient(270deg, ' + COLOR + ' 50%, ' + BACKGROUND_COLOR + ' 50%, ' + BACKGROUND_COLOR + ')';
	...
	var ui = function ui(pourcent, edit) {
	  return (0, _dom.div)({ style: {
	      width: '90vmin',
	      height: '90vmin',
	      borderRadius: '50%',
	...
	function main(_ref) {
	  ...
	  var click$ = DOM.select('.app').events('click');
	  var timeout$ = DOM.select('.timeout').events('change').pluck('target').pluck('value').startWith(30000).scan(function (curr, next) {
	    try {
	  ...
	  var timer$ = click$.startWith('').withLatestFrom(timeout$, function (noop, timeout) {
	    var latestValue = timeout * (COLORS.length - 1);
	    return animation.pluck('delta').scan(function (sum, delta) {
	      return sum + delta;
	    }).takeWhile(function (sum) {
	      return sum < latestValue;
	    }).concat(_rx.Observable.just(latestValue)).map(function (delta) {
	      return delta / timeout;
	    });
	  }).switch();

	  var edit$ = click$.buffer(function () {
	    return click$.debounce(250);
	  }).map(function (arr) {
	    return arr.length;
	  }).filter(function (x) {
	    return x === 2;
	  }).startWith(false).scan(function (d) {
	    return !d;
	  });

	  var editUI$ = edit$.combineLatest(timeout$, function (edit, timeout) {
	    if (!edit) return null;
	    return (0, _dom.input)({
	      className: 'timeout',
	      value: timeout,
	...
	//# sourceMappingURL=data:application/json;base64,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _performanceNow = __webpack_require__(64);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ = __webpack_require__(67).runInContext();
	module.exports = __webpack_require__(68)(_, _);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var mapping = __webpack_require__(69),
	    mutateMap = mapping.mutate,
	    fallbackHolder = __webpack_require__(70);
